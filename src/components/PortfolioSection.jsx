export default function PortfolioSection() {
  const portfolioItems = [
    ...
    },
    {
      ...
      description:
        "Premium photography and 360° dining room showcase",
      image:
    ...
    <section id="portfolio" className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 mb-10">
          Discover how we've transformed hospitality spaces into captivating digital experiences
        </p>
        ...
        <button className="mt-10 px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-100 transition">
          View Full Portfolio
        </button>
      </div>
    </section>
